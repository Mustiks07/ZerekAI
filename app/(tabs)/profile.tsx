...
export default function ProfileScreen() {
  ...
  const loadProfileData = async (userId: string, cachedSubjects: Subject[]) => {
    try {
      ...
      // Chart: last 12 quiz results → predicted UBT score (score/total * 140)
      ...
      // Achievements — using currentStreak from hook (already loaded)
      ...
      // Note: currentStreak comes from the hook which loads from Supabase
      // We read it from the store via the hook; use the snapshot at load time
